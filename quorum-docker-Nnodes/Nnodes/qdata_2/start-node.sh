...
GETH_ARGS="--datadir /qdata/dd --mine --minerthreads 1 --syncmode full --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --unlock 0 --password /qdata/passwords.txt"
